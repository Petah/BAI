...
import org.petah.spring.bai.map.control.ControlMapRenderer;

/**
 *
 * @author Petah
 */
public class PControlMap extends javax.swing.JPanel implements UpdateListener {
    ...
    public PControlMap(ControlMap controlMap) {
        this.controlMap = controlMap;
        initComponents();
        image = new BufferedImage(GlobalDelegate.getMapWidth(), GlobalDelegate.getMapHeight(), BufferedImage.TYPE_INT_RGB);
    ...
    public void updateImage() {
        if (imageFuture != null) {
            try {
                ...
                Logger.getLogger(PControlMap.class.getName()).log(Level.SEVERE, null, ex);
        ...
        imageFuture = ThreadManager.run("PControlMap.updateImage()",new Runnable() {
            ...
            public void run() {
                EventQueue.invokeLater(new Runnable() {
                    ...
                    public void run() {
                        ControlMapRenderer.renderControlMap(controlMap, image);
                        updateUI();
                    }
                });
            }
    ...
    private void cbAutoUpdateActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_cbAutoUpdateActionPerformed
        if (cbAutoUpdate.isSelected()) {
            controlMap.addUpdateListener(this);
        } else {
            controlMap.removeUpdateListener(this);
        }
