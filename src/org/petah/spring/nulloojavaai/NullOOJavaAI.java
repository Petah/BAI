 ...
 */
package org.petah.spring.nulloojavaai;
...
public class NullOOJavaAI extends AbstractOOAI implements OOAI {
    ...
    public NullOOJavaAI(int teamId, OOAICallback callback) {
    ...
    public int update(int frame) {
        ...
        if (frame % 300 == 0) {
            ...
            for (Resource resource : resources) {
                sendTextMsg("Resource " + resource.getName() + " optimum: " + resource.getOptimum());
                sendTextMsg("Resource " + resource.getName() + " current: " + clb.getEconomy().getCurrent(resource));
                sendTextMsg("Resource " + resource.getName() + " income: " + clb.getEconomy().getIncome(resource));
                sendTextMsg("Resource " + resource.getName() + " storage: " + clb.getEconomy().getStorage(resource));
                sendTextMsg("Resource " + resource.getName() + " usage: " + clb.getEconomy().getUsage(resource));
            }
        }
